...
<body>       
    ...
    if (isset($_POST['pizza']) && isset($_POST['anzahl'])) {
        ...
        // Hinweis: Hier müssen sowohl das Cookie als auch der Wert im Array $_COOKIE
        // angepasst werden, da im selben Request auf das Array zugegriffen wird.
